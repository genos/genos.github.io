...
results](https://github.com/genos/Workbench/blob/main/means/justfile#L20-L56).
Here's the plot of #floats vs. nanoseconds (click on it for the full SVG); note
the log-log scale.


[![Times in nanoseconds, by #floats and function version](/images/means.svg)](/images/means.svg)
