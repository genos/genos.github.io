...
(Unfortunately) obligatory notice: Nothing here was written with or by a large language model (LLM).
Quoting the introduction of [Modern Common Lisp with FSet](https://fset.common-lisp.dev/Modern-CL/Top_html/index.html),
